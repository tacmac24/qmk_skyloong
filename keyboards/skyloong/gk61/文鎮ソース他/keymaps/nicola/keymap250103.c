...
//      KC_UP, を RSFT_T(KC_UP), に さらに KC_RSFT-T(KC_UP) に
        MO(_FUNC),   KC_LALT,  KC_LGUI, KC_SPC,  _______, KC_F14, MO(_FUNC), KC_LEFT, KC_DOWN, KC_RIGHT
...
//        KC_HOME,     KC_LALT,  KC_LGUI,  NG_SHFTL, _______,  NG_SHFTR,  MO(_FUNC), KC_LEFT,  KC_DOWN,  KC_RSFT
