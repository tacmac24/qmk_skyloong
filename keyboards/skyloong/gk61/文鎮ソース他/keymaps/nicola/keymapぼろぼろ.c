...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
     ...
     * ├───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┼───┤
     * │Cap│GUI│Alt│   │Spc│Mut│   │   |Spc|Alt│App│Ctl│   │Mo1|
     * └───┴───┴───┴───┴───┴───┴───┴───┴───┴───┴───┴───┴───┴───┘
     */
    ...
    [_QWERTY] = LAYOUT_all(
        ...
        KC_LCTL,      KC_LGUI,  KC_LALT,            KC_SPC,  KC_F14,                         KC_SPC,   MO(_FUNC), KC_LEFT,  KC_DOWN,            KC_RIGHT
    ),
    ...
    [_NICOLA] = LAYOUT_all(
        ...
        KC_CAPS_LOCK,     KC_LALT,    KC_LGUI,         NG_SHFTL,  _______,                       NG_SHFTR, MO(_FUNC), KC_LEFT,  KC_DOWN,            KC_RIGHT
    ),
