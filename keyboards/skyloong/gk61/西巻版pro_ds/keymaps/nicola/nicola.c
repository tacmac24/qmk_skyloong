...
void nicola_m_type(void) {
    ...
    if (n_modifier == 0) {
        switch(nicola_m_key) {
            ...
            case NG_Q   : send_string("." ); break;     //句読点
...
//            case NG_P : send_string("p/"); break; // コンマ（かわせみ専用）
            case NG_P : send_string("/"); break; 
            case NG_LBRC: send_string(","); break; // 句読点・読点
...
//            case NG_Z   : send_string("q/" ); break;     //ピリオド（かわせみ専用）
            case NG_Z   : send_string("." ); break;     //ピリオド（かわせみ専用）
...
//            case NG_2   : send_string("z/"); break;      // ・（かわせみ専用）
            case NG_2   : send_string("/"); break;      // ・（かわせみ専用）
...
//            case NG_0   : send_string(")"); break;      // ）
            case NG_8   : send_string("("); break;      // （ //親指入力の時だけ（）をずらしてある
            case NG_9   : send_string(")"); break;      // ）
            case NG_0   : send_string("*"); break;      // ＊
            ...
            case NG_Z   : send_string("xu"); break; // ぅ
        ...
        switch(nicola_m_key) {
            case NG_1   : send_string("!"); break;      // ！（左親指時に）
            case NG_2   : send_string("/"); break;      // ・⌥/ スラッシュ
            case NG_3   : send_string("~"); break;      // ～
            case NG_4   : send_string("["); break;      // 「
            case NG_5   : send_string("]"); break;      // 」
            case NG_6   : send_string("{"); break;      // 『
...
//            case NG_0   : send_string(")"); break;      // ）
            ...
            case NG_Q   : send_string("wyi"); break;   // ゐ
            ...
            case NG_Z   : send_string("wye");break; // ゑ
//            case NG_Z   : UC("FF0C");break; // ，エラーが出ました（ユニコード）
