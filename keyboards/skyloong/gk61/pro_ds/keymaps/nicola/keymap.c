...
const uint16_t PROGMEM keymaps[][MATRIX_ROWS][MATRIX_COLS] = {
    ...
    [_QWERTY] = LAYOUT_all(
        ...
        KC_LSFT,   KC_Z,   KC_X,    KC_C,     KC_V,     KC_B,     KC_N,     MY_M,    KC_COMM,  KC_DOT,    KC_UP,            KC_RSFT,
    ...
    [_NICOLA] = LAYOUT_all(
        ...
        KC_LSFT,   NG_Z,   NG_X,   NG_C,   NG_V,   NG_B,      NG_N,     MY_M,     NG_COMM,  NG_DOT,    NG_SLSH,            KC_RSFT,
    ...
    [_FUNC] = LAYOUT_all(
        ...
        KC_LCTL, _______,  KC_LEFT,  KC_RIGHT,  _______,   _______,   _______,  _______,  KC_HOME,  KC_PGUP,   _______,  _______,            _______,
        _______,      _______,  KC_DOWN,  _______,  _______,   _______,   _______,  _______,  _______,  KC_PGDN,   KC_SLSH,            KC_RSFT,
